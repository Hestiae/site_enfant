    ...
    <section id="speakers-details" class="fadeIn">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="details">
              <h2>Marie-Camille CHAVANNE</h2>
              <p> <i>Motivée, créative, et sérieuse je suis en première année de BTS Services Informatiques Aux Organisations Option SLAM(Solution Logiciel et Application Métier)</i>. <br/><br/>
              J'aime le travail en équipe pour la création d'un site web divers points de vues sont obligatoirement interressant, mais c'est surtout la création d'une expérience utilisateur qui me motive te qui me pousse à me remettre en question sur mon travail.
              <br/><br/><br/>
              Si tu veux que l'ont travaille ensemble contacte moi ! <br/>
              <div class="social">
