    ...
    <section id="speakers-details" class="fadeIn">
      <div class="container">
        <div class="section-header">
          <h2>Parc des expostions</h2>
          <p>Description</p>
        </div>

        <div class="row">
          <div class="col-md-6">
            <img src="../img/hotels/11.jpg" alt="Speaker 1" class="img-fluid">
          </div>
          ...
          <div class="col-md-6">
            <div class="details">
              ...
              <p> Paris Expo Porte de Versailles est le plus grand parc d'exposition d'Europe, au coeur de la capitale.
Le Paris Convention Centre, inauguré en novembre 2017, est le plus grand centre de congrès d'Europe et permet d'accueillir jusqu'à 30 000 congressistes.
Depuis plus de 90 ans Paris Expo Porte de Versailles bénéficie d’une notoriété internationale, il vous offre une visibilité unique pour donner de l’ampleur à vos événements, aussi bien salons que plénière, conventions, diner, cocktail
</p>
<a href="https://www.viparis.com/fr/site/paris-expo-porte-de-versailles">Parc des expositions</a>
            </div>
          </div>
